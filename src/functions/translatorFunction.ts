...
/**
 * Provides basic HTML/Javascript FE for Translator operation
 * @param request Client GET request
 * @param context index.html page with Javascript
 * @returns 
 */
async function translatorHandler(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
